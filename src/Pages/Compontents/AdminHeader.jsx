...
const AdminHeader = () => {
    ...
    const handleProfile = () => setOpenModal(!openModal)
    return (
        <div > 
                ...
                <Modal.Body>
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-center flex-col">
                            ...
                            <p className=' font-semibold text-2xl mt-2'>Admin Name</p>
                            <p className=' font-semibold text-1xl mt-2'>Johnseby@gmail.com</p>

                            <div className="w-[80%] h-full p-5 bg-slate-100 mt-5 rounded-2xl flex items-center justify-center">
                                <a className='font-semibold  text-lg' href="/orders">Branch Name</a>
                            </div>

                            <div className="w-[80%] h-full p-5 bg-slate-100 mt-5 rounded-2xl flex items-center justify-center">
                                <a className='font-semibold  text-lg' href="">Location</a>
                            </div>
